...
const data: Game[] = [
  {
    ...
    cover: 'https://images.igdb.com/igdb/image/upload/t_cover_med/co1rbo.jpg',
    isFavorite: true,
  ...
  },
  {
    ...
    genres: ['Fighting'],
    cover: 'https://images.igdb.com/igdb/image/upload/t_cover_med/co20mh.jpg',
    isFavorite: true,
    editions: [
  ...
  },
  {
    ...
    cover: 'https://images.igdb.com/igdb/image/upload/t_cover_med/co209g.png',
    isFavorite: true,
    editions: [{ platform: 'PC', isCompleted: true }],
  },
  {
    ...
    genres: ['Racing', 'Simulator'],
    cover: 'https://images.igdb.com/igdb/image/upload/t_cover_med/co209h.png',
    isFavorite: true,
    editions: [{ platform: 'PC', isCompleted: true }],
  },
  {
  ...
  },
  {
    ...
    cover: 'https://images.igdb.com/igdb/image/upload/t_cover_med/co2l1t.png',
    isFavorite: true,
    editions: [{ platform: 'PC', isCompleted: true }],
  },
  {
